...
ADD COLUMN cpi_adjusted_cost_fix bigint;


-- Updating new column

UPDATE us_natural_disaster_cost
SET cpi_adjusted_cost_fix = cpi_adjusted_cost * 1000000000;

SELECT cpi_adjusted_cost, cpi_adjusted_cost_fix
FROM us_natural_disaster_cost;
...
SELECT
	SUM(cpi_adjusted_cost_fix) AS "total cpi adjusted cost"
FROM us_natural_disaster_cost;
